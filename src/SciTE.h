...
#define VERSION_SCITE "5.1.1"
#define VERSION_WORDS 5, 1, 1, 0
#define COPYRIGHT_DATES "December 1998-July 2021"
#define COPYRIGHT_YEARS "1998-2021"
#define VERSION_SCINTILLA "5.1.1"
#define VERSION_LEXILLA "5.1.1"
